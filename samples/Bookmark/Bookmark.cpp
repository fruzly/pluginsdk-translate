...
void PILoadRibbonUI(void* pParentWnd)
{
	...
	FRPanelViewCallbacks.FRPanelViewGetName = CBookmarkToolHander::Tool_GetName;
	FRPanelViewCallbacks.FRPanelViewGetTitle = CBookmarkToolHander::Tool_GetTitle;
	FRPanelViewCallbacks.FRPanelViewInitNewView = CBookmarkToolHander::Tool_InitNewView;
	FRPanelViewCallbacks.FRPanelViewOnGetHwnd = CBookmarkToolHander::Tool_PanelViewOnGetHwnd;
	FRPanelViewCallbacks.FRPanelViewOnPanelActive2 = CBookmarkToolHander::Tool_PanelViewOnPanelActive;
	FRPanelViewCallbacks.FRPanelViewOnActive = CBookmarkToolHander::Tool_SetActiveView;
	FRPanelViewCallbacks.FRPanelViewOnDestroyView = CBookmarkToolHander::Tool_CloseView;
	FRPanelViewCallbacks.FRPanelViewGetButtonTip = CBookmarkToolHander::Tool_GetButtonTip;
	FRPanelViewCallbacks.FRPanelViewGetButtonIconUnion = CBookmarkToolHander::Tool_PanelViewGetButtonIconUnion;
