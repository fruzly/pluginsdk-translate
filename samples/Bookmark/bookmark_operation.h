...
#define SAMPLE_BOOKMARK_USERMSG_SHOWBOOKMARK (WM_USER+100)
#define SAMPLE_BOOKMARK_USERMSG_DELETEBOOKMARK (WM_USER+200)

class Bookmark_Operation 
{
public:
    Bookmark_Operation(HWND hNavPage);
