...
BEGIN_MESSAGE_MAP(CMyTreeCtrl, CTreeCtrl)	
	...
	ON_WM_LBUTTONDOWN()
	ON_WM_CREATE()
	ON_MESSAGE(SAMPLE_BOOKMARK_USERMSG_SHOWBOOKMARK, &CMyTreeCtrl::OnShowBookmark)
	ON_MESSAGE(SAMPLE_BOOKMARK_USERMSG_DELETEBOOKMARK, &CMyTreeCtrl::OnDeleteBookmark)
END_MESSAGE_MAP()
